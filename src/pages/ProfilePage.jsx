                    ...
                    <div className="flex flex-col items-center gap-4">
                        <div className="relative group">
                            ...
                            <button
                                ...
                                className={`absolute bottom-1 right-1 w-9 h-9 rounded-full bg-base-300 border border-base-100 flex items-center justify-center cursor-pointer hover:bg-primary hover:text-white transition-all duration-200 ${isUpdatingProfile ? "animate-pulse pointer-events-none" : ""
                                    }`}
                            >
                                {isUpdatingProfile ? (
